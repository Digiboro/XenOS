...
use crate::acpi::address::GenericAddress;
use crate::acpi::registers::FixedRegisters;
use crate::acpi::registers::Pm1ControlBit;
use crate::acpi::registers::Pm1Event;
use crate::acpi::sdt::Signature;
use crate::acpi::sdt::fadt::Fadt;
use crate::acpi::sdt::madt::Madt;
use crate::acpi::sdt::madt::MadtError;
use crate::acpi::sdt::madt::MpProtectedModeWakeupCommand;
use crate::acpi::sdt::madt::MultiprocessorWakeupMailbox;
