...
use crate::acpi::aml::resource::InterruptPolarity;
use crate::acpi::aml::resource::InterruptTrigger;
pub use crate::acpi::aml::resource::IrqDescriptor;
use crate::acpi::aml::resource::Resource;
use crate::acpi::aml::resource::{self};
