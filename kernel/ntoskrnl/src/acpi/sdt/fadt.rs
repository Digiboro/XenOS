...
use crate::acpi::address::AddressSpace;
use crate::acpi::address::GenericAddress;
use crate::acpi::address::RawGenericAddress;
use crate::acpi::sdt::ExtendedField;
...
impl Fadt {
    pub fn validate(&self) -> Result<(), AcpiError> {
        unsafe { self.header.validate(crate::acpi::sdt::Signature::FADT) }
    }
