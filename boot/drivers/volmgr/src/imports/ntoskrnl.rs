...
unsafe extern "win64" {
    ...
    pub fn RtlFreeUnicodeString(unicode_string: *mut UNICODE_STRING);
    
    // Event functions for synchronous I/O
...
// Completion routine control flags
